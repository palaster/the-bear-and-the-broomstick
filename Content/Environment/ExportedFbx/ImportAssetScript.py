...
#Use this command : py "C:\Users\Mr Badger\Desktop\ExportedFbx\ImportAssetScript.py"
...
def ImportAllAssets():
	...
	def CreateTask_SM_Islands():
		...
		FilePath = os.path.join(r'C:\Users\Mr Badger\Desktop\ExportedFbx\StaticMesh\SM_Islands.fbx')
		AdditionalParameterLoc = os.path.join(r'C:\Users\Mr Badger\Desktop\ExportedFbx\StaticMesh\SM_EmptyCollectionForUnrealExport_Temp_AdditionalParameter.ini')
